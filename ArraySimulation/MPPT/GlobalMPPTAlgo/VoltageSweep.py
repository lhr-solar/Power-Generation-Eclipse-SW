...
lower and upper bounds of the global maximum. The voltage sweep increments slowly through a voltage values
finding all local maxima that will be compared to each other to find at what voltage point the global
maximum lies.
